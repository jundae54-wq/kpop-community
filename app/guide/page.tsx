        ...
        <div className="min-h-screen bg-zinc-950 text-white selection:bg-brand selection:text-white">
            ...
            <section className="relative px-6 py-24 text-center overflow-hidden flex flex-col items-center justify-center">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold tracking-tight mb-6">
                    Bem-vindo à <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand to-pink-500 whitespace-nowrap">K-Community</span>
                </h1>
                <p className="text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto mb-10 leading-relaxed">
                    Muito mais do que um feed de notícias. É o seu espaço seguro e exclusivo para descobrir as últimas novidades da Coreia e se conectar com fãs de verdade, sem a toxicidade de outras redes.
                </p>
            </section>
            ...
            <section className="max-w-5xl mx-auto px-6 py-12 space-y-24">
                    ...
                    <div className="flex-1 w-full bg-zinc-900 border border-white/10 rounded-2xl p-6 shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-2">
                                <span className="px-3 py-1 bg-brand/20 text-brand text-xs rounded-full">Notícia</span>
                                <span className="px-3 py-1 bg-zinc-800 text-zinc-400 text-xs rounded-full">Traduzido</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row-reverse items-center gap-12">
                    <div className="flex-1 space-y-4 text-center md:text-left">
                        ...
                        <h2 className="text-3xl font-bold">Resort Exclusivo do Seu Fandom</h2>
                        <p className="text-zinc-400 text-lg">
                            Cansado do caos dos algoritmos e de guerras entre fandoms? Nós oferecemos fóruns dedicados e moderados para k-pop e k-dramas. Conecte-se com pessoas que compartilham da mesma paixão, em um ambiente livre de pessoas tóxicas.
                        </p>
                    </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1 space-y-4 text-center md:text-left">
                        ...
                        <h2 className="text-3xl font-bold">Ganhe Recompensas Diárias</h2>
                        <p className="text-zinc-400 text-lg">
                            Nós valorizamos a sua presença. Ganhe pontos apenas por fazer login diariamente, comentar ou criar posts. Use seus pontos na Loja para comprar nomes coloridos e emblemas exclusivos para mostrar o seu nível VIP no fandom!
                        </p>
                    </div>
                    <div className="flex-1 w-full bg-zinc-900 border border-white/10 rounded-2xl p-6 shadow-2xl flex flex-col items-center justify-center py-10">
                        ...
                        <div className="text-xl font-bold text-yellow-500">+10 Pontos</div>
                        <p className="text-sm text-zinc-500 mt-1">Bônus Diário de Login</p>
                    </div>
                </div>
            ...
            <section className="text-center py-24 px-6 border-t border-white/5 bg-zinc-900/20">
                <h2 className="text-3xl font-bold mb-6">Pronto para mergulhar de cabeça?</h2>
                <p className="text-zinc-400 mb-8 max-w-lg mx-auto">
                    Altere sua foto de perfil, escolha a sua categoria favorita e se apresente para a comunidade agora mesmo.
                </p>
                <Link
                    href="/community"
